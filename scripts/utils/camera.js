export default class Camera {
  ...
  // Konstruktor yang menerima elemen DOM yang diperlukan
  constructor() {
    this.#videoElement = document.getElementById('camera-video');  // Elemen video
    this.#selectCameraElement = document.getElementById('camera-select');  // Elemen select kamera
    this.#canvasElement = document.getElementById('camera-canvas');  // Elemen canvas
