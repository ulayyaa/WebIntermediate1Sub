...
export default class NewPage {
        ...
        <div class="new-story__header">
          <div class="container">
            ...
            <p class="new-story__header__description">
              Silakan lengkapi formulir di bawah untuk membuat story kamu!<br>
        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            <div class="form-control">
              ...
              <div class="new-form__title__container">
                <input
                  id="title-input"
                  name="title"
                  placeholder="Masukkan judul story kamu"
                  aria-describedby="title-input-more-info"
                >
              </div>
              <div id="title-input-more-info">Pastikan judul story dibuat dengan jelas dan deskriptif dalam 1 kalimat.</div>
            </div>
            <div class="form-control">
              <div class="new-form__damage-level__title">Tingkat Perasaan</div>
              ...
              <div class="new-form__damage-level__container">
                <div class="new-form__damage-level__minor__container">
                  ...
                  <label for="damage-level-minor-input">
                    Sedih <span title="Contoh: Badmood, ketolak magang, skripsi revisi, dll."><i class="far fa-question-circle"></i></span>
                  </label>
                </div>
                <div class="new-form__damage-level__moderate__container">
                  ...
                  <label for="damage-level-moderate-input">
                    Biasa aja <span title="Contoh: Tidak ada hal apapun yang terjadi tapi pengen cerita, dll."><i class="far fa-question-circle"></i></span>
                  </label>
                </div>
                <div class="new-form__damage-level__severe__container">
                  ...
                  <label for="damage-level-severe-input">
                    Senang <span title="Contoh: Submission yang aku kerjain 2 minggu akhirnya ada pencerahan, dll."><i class="far fa-question-circle"></i></span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div class="form-control">
              ...
              <div id="documentations-more-info">Kamu dapat menyertakan foto selfie sebagai dokumentasi.</div>
  ...
  this.#camera = new Camera({
    ...
    cameraSelect: document.getElementById('camera-select'),  // Pass the DOM element here
